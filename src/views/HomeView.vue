...
<template>
  <main class="d-flex flex-column gap-5">
    <nav class="navbar d-flex justify-content-end navbar-expand-lg bg-transparent">
      <div class="bg-transparent">
          <div id="navbarNavDarkDropdown">
              <ul class="navbar-nav d-flex justify-content-end w-100">
                  <li class="nav-item dropdown d-flex justify-content-end flex-column align-items-end">
